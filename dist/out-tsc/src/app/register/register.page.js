...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(router, loadingCtrl, toastCtrl, authService) {
        this.router = router;
    ...
    RegisterPage.prototype.exibirLogin = function () {
        this.router.navigate(['login']);
    };
    RegisterPage.prototype.fazerRegistro = function () {
